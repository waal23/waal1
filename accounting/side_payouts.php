...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">All Payouts</h3> </div>
                                ...
                                try {
                                    ...
                                    foreach ($catArray as $iValue) {
                                        ...
                                        if ($status === "pending"){
                                            ...
                                            $status = "<span/><a target='_blank' href=\"../dashboard/edit_payout.php?objectId=$objectId\" class=\"badge badge-warning\">Complete now</a></span>";
                                        } else {
                                            $status = $status = "<span/><a target='_blank' href=\"../dashboard/edit_payout.php?objectId=$objectId\" class=\"badge badge-success\">Completed</a></span>";
                                        }
