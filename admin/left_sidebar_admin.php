    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li>
                    <a class="has-arrow  " href="../dashboard/panel.php" aria-expanded="false"><i class="fa fa-tachometer"></i><span class="hide-menu">Admin Panel </span></a>
                </li>
               ...
               <!-- <li>
                ...
                <li>
                    <a class="has-arrow  " href="../dashboard/posts.php" aria-expanded="false"><i class="fa fa-clipboard"></i><span class="hide-menu">Posts</span></a>
                </li>
                ...
                <li>
                    <a class="has-arrow  " href="../dashboard/payments.php" aria-expanded="false"><i class="fa fa-credit-card"></i><span class="hide-menu">Payments</span></a>
                </li>
                <li>
                    <a class="has-arrow  " href="../dashboard/payouts.php" aria-expanded="false"><i class="fa fa-money"></i><span class="hide-menu">Payouts</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="../dashboard/payouts.php">All Payouts</a></li>
                        <li><a href="../dashboard/payouts_pending.php">Pending Payouts</a></li>
                        <li><a href="../dashboard/payouts_processing.php">Processing Payouts</a></li>
                    </ul>
                </li>
